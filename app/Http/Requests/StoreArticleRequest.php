...
class StoreArticleRequest extends FormRequest
{
    ...
    {
        return [
            'article' => 'required|string|max:191',
            'reference' => 'required|string|max:191|unique:articles,reference',
            'code_barre' => 'nullable|string|max:191|unique:articles,code_barre',
            ...
            'quantite_acquise' => 'required|integer|min:0',
